...
class Configurator
{
	 ...
	 * @param  bool|string|string[]  $value  true/false or IP addresses/computer names whitelist
	 */
	 ...
	 * @param  string|string[]|null  $list  IP addresses or computer names whitelist
	 */
